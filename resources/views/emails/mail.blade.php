...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            <h2> Verify Your Login with OTP</h2>
            <p style="margin-bottom: 0px;">Hi {{ $user->name }},</p>
            <p style="margin-top: 12px;">
                We noticed a login attempt for your Goodiset account and need to verify it's really you.


            </p>

            <p>Here Is Your One-Time Password (OTP)</p>
            <div class="reset-pin">{{ $user->otp }}</div>

            <p>For your security, this OTP will expire in 5 minutes.

                If you didn’t try to log in, please ignore this email or contact us immediately.</p>
