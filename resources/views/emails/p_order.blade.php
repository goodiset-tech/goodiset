                ...
                <table class="email-container" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td class="email-content">
                            <h2>Your Order is @if ($edit->dstatus == 2)
                                    Delivered
                                @elseif($edit->dstatus == 1)
                                    Confirmed
                                @elseif($edit->dstatus == 4)
                                    on the Way! 🚚
                            ...
                            @if ($edit->dstatus == 2)
                                <p style="margin-top: 10px;">Thank you for shopping with Goodiset! We’re thrilled to let
                                    you know that your
                                    order has been delivered
                                </p>
                            @elseif($edit->dstatus == 3)
                                <p style="margin-top: 10px;">
                                    We regret to inform you that your order has been canceled. We’re always working to
                                    improve and hope to serve you again soon!
                                </p>
                            @else
                                <p style="margin-top: 10px;">Thank you for shopping with Goodiset! We’re thrilled to let
                                    you know that your
                                    order has been @if ($edit->dstatus == 2)
                                        delivered
                                    @elseif($edit->dstatus == 1)
                                        confirmed and is now being prepared for delivery
                                    @elseif($edit->dstatus == 4)
                                        on the Way! 🚚
                                    @elseif($edit->dstatus == 3)
                                        Canceled
                                ...
                                <p style="margin-bottom: 5px; font-weight: 600; color: #000000;">Estimated Turnaround
                                    Time</p>
                            ...
                            <a href="{{ url('/') }}/thanks/{{ $edit->encrypted_order_no }}" class="activate-btn"
                                style="color:white">View or Manage Order</a>
                            @if ($edit->dstatus >= 1 && $edit->company_name == 'Jeebly')
                                <a href="{{ $edit->track_url }}" class="activate-btn" style="color:white">Track Your
                                    Order</a>
                            @endif
                            ...
                            <div class="order-detailss">
                                ...
                                <table width="100%" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr class="order-item">
                                        ...
                                        <td align="right">
                                            <p>{{ $value->qty * $value->package_price }}
                                                <img src="{{ asset('front/assets/icons/aed_symbol.png') }}"
                                                    alt="AED" height="14"
                                                    style="vertical-align: middle; height:10px;width:10px">
                                            </p>
                                ...
                                <table width="100%" style="margin-top: 24px;" cellspacing="0" cellpadding="0">
                                    <tr>
                                        ...
                                        @php
                                            $subtotal = $edit->amount - $edit->shipping_fee + $edit->discount;
                                        @endphp
                                        <td class="subtotal" align="right"><?= $subtotal ?>
                                            <img src="{{ asset('front/assets/icons/aed_symbol.png') }}" alt="AED"
                                                height="14" style="vertical-align: middle; height:10px;width:10px">
                                        </td>
                                    </tr>
                                    @if ($edit->coupon_code)
                                        <tr>
