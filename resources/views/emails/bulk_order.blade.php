            ...
            <td align="center">
                <table class="email-container" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                    ...
                    <td class="email-content">
                                <h2>Your Order is @if($edit->dstatus == 2) Delivered @elseif($edit->dstatus == 1 ) Confirmed @elseif($edit->dstatus == 4) on the Way! 🚚 @elseif($edit->dstatus == 3) Canceled @endif</h2>
                                ...
                                @else
                                <p style="margin-top: 10px;">Thank you for shopping with Goodiset! We’re thrilled to let you know that your
                                    order has been @if($edit->dstatus == 2) delivered @elseif($edit->dstatus == 1 ) confirmed and is now being prepared for delivery @elseif($edit->dstatus == 4) on the Way! 🚚 @elseif($edit->dstatus == 3) Canceled @endif .
                                </p>
                                <p style="margin-bottom: 5px; font-weight: 600; color: #000000;">Estimated Turnaround Time</p>
                                <p style="margin-top: 0;">Your order is expected to arrive within <span class="duration">{{getSetting('shipping_time')}}</span>
                                </p>
