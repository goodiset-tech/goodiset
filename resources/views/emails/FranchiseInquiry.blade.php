...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            ...
            <p>A new franchise inquiry has been submitted through the Contact Us form.</p>
            ...
            <div class="details">
                ...
                <table>
                    ...
                    <tr>
                        <td>Country</td>
                        <td class="b-text">{{ $user->country }}</td>
                    </tr>
                    <tr>
                        <td>Location of Interest</td>
                        <td class="b-text">{{ $user->event_location }}</td>
                    </tr>
                    <tr>
                        <td>Model Type</td>
                        <td class="b-text">{{ $user->model_type }}</td>
                    </tr>
                    <tr>
                        <td>Estimated Investment Budget</td>
                        <td class="b-text"> {{ $user->estimated_investment_budget }}</td>
                    </tr>
                </table>
            </div>
            ...
            <p style="font-size: 18px;">Please reach out to discuss the franchise opportunity.</p>
