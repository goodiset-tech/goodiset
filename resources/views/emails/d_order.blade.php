...
<body>
    <div class="email-container">
        ...
        <div class="order-details">
            ...
            <p>Please Give Us Review About Our Product.<strong>Product Link Is Available Below</strong></p>
            <p>Order Number: <strong>{{$edit->order_no}}</strong></p>
            <p>Order Date: <strong><?= date('F d Y',strtotime($edit->created_at));?></strong></p>
        </div>
