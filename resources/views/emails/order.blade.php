                ...
                <table class="email-container" cellpadding="0" cellspacing="0" bgcolor="#ffffff">
                    ...
                    <tr>
                        <td class="email-content">
                            ...
                            <p>Hi {{ $edit->customer_name }},</p>
                            <p>Thank you for your purchase! We've received your order
                                <strong>#{{ $edit->order_no }}</strong>, and it is on its way.
                            </p>

                            <p><strong>Estimated Turnaround Time:</strong><br>
                                {{-- Expected to be delivered in  --}}
                                <span
                                    style="color: #e92827;">{{ get_shipping_time($edit->city, $edit->country) }}</span>.
                            </p>
