...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            <h2>Event Organizer Inquiry</h2>
            <p>A new retailer inquiry has been submitted through the Contact Us form.</p>
                ...
                <table style="width: 100%;">
                    ...
                    @if ($user->shop_count)
                        <tr>
                            ...
                            <td class="b-text">{{ $user->shop_count }}</td>
                        </tr>
                    @endif
                    @if ($user->monthly_kilo_order)
                        <tr>
                            <td>Monthly Order Quantity</td>
                            <td class="b-text">{{ $user->monthly_kilo_order }}</td>
                        </tr>
                    @endif
                </table>
            </div>
