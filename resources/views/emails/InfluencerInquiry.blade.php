...
<body>
    <div class="email-container">
        ...
        <div class="email-content">
            <h2>New Influencer Inquiry</h2>
            <p>A new Influencer inquiry has been submitted through the Contact Us form.</p>
            ...
            <div class="details">
                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="b-text">{{ $user->influencer_platform }}</td>
                    </tr>
                    <tr>
                        <td>Number of Followers</td>
                        <td class="b-text">{{ $user->follower_count }}</td>
                    </tr>
                    <tr>
                        <td>Social Media Username</td>
                        <td class="b-text">{{ $user->username }}</td>
                    </tr>
                </table>
            </div>
