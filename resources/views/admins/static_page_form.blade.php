            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form action="{{ url('/') }}/admin/static_page_form" id="page_form" class="form-horizontal" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12"><input type="file" accept="image/png, image/gif, image/jpeg"
                                    ...
                                    @if ($edit)
                                        <img src=" {{ asset('') }}img/slider/{{ $edit->page_image }}"
                                            alt="" <?php echo $edit->page_image != null ? 'style="width:100px;"' : 'style="display:none;width:100px;"'; ?>>
                                        @endif
                                </div>
