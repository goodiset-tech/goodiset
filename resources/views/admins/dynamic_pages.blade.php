        ...
        <div class="ibox float-e-margins">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $key+1 ?></td>
                    <td>{{$page->name}}</td>
                    <td><a href="{{ url('/category/' . $page->slug) }}" target="_blank">{{ $page->name }}</a></td>
                    <td>
                        <img src="<?php echo isset($page->banner) ? asset($page->banner) : null; ?>" alt="" <?php echo isset($page->banner) ? 'style="width:100px;"' : 'style="display:none;width:100px;"'; ?>>
                    </td>
                    <td>
                        <a href="{{route('admins.dynamic_page_form',$page->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i>&nbsp;Edit</a>
