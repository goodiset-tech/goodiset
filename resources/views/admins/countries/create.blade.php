...
@section('title', isset($edit) ? 'Edit Country' : 'Add Country')
            ...
            <div class="col-lg-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>{{ isset($edit) ? 'Edit' : 'Add' }} Country</h5>
                    </div>
                    <div class="ibox-content">
                        <form class="form-horizontal" method="post" action="{{ isset($edit) ? route('admins.countries.update', $edit->id) : route('admins.countries.store') }}">
                            @csrf
                            @if(isset($edit))
                                @method('PUT')
                            @endif
