            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="POST" action="{{ route('admins.locations.update', $location->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="location_name" id="location_name" class="form-control"
                                        value="{{ $location->location_name }}" readonly>
                                    @error('location_name')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($location->image)
                                        <p>Current Image: <img src="{{ asset($location->image) }}" alt="Location Image"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="open_close_time" class="form-control"
                                        value="{{ $location->open_close_time }}" placeholder="e.g., 09:00-17:00">
